...
rename table  course_section to course_chapter;
...
alter table course_chapter_section
    add created_date datetime default now() null;

alter table course_chapter_section
    add updated_date datetime default now() null;
